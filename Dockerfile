...
USER container
ENV USER=container HOME=/home/container LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libmimalloc.so.2.0 MIMALLOC_PAGE_RESET=0 HUGETLB_MORECORE=thp MIMALLOC_LARGE_OS_PAGES=1
